            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100">
                <div class="p-8 text-gray-900">
                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Section 1: Basic Info & Stock -->
                        <div class="mb-8 border-b border-gray-100 pb-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Informasi Produk</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Produk</label>
                                    <input type="text" name="name" value="{{ old('name', $product->name) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary transition" required>
                                </div>
                                ...
                                <div class="bg-orange-50 p-4 rounded-lg border border-orange-100">
                                    <label class="block text-sm font-bold text-gray-800 mb-1">Stok Saat Ini (Refill)</label>
                                    <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" class="block w-full text-xl font-bold rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary text-center text-primary" required min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8 border-b border-gray-100 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="price" value="{{ old('price', $product->price) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary" required>
                                </div>
                                <div class="relative">
                                    <label class="block text-sm font-medium text-gray-600 mb-1">Harga Beli Min. 3</label>
                                    <input type="number" name="price_3_items" value="{{ old('price_3_items', $product->price_3_items) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary bg-gray-50" placeholder="Opsional">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price_5_items" value="{{ old('price_5_items', $product->price_5_items) }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary bg-gray-50" placeholder="Opsional">
                         ...
                         <div class="mb-8">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Foto Produk</h3>
                            
                            <!-- Existing Photos -->
                            <div class="mb-4">
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Foto Saat Ini</label>
                                <div class="flex flex-wrap gap-4">
                                    @if($product->images->count() > 0)
                                        @foreach($product->images as $img)
                                            <div class="relative w-24 h-24 rounded-lg overflow-hidden border border-gray-200 shadow-sm group">
                                                <img src="{{ asset('storage/' . $img->image_path) }}" class="w-full h-full object-cover">
                                                <!-- Delete button logic could be added here in future (e.g. separate livewire component or API) -->
                                            </div>
                                        @endforeach
                            ...
                            <div x-data="{ 
                                ...
                                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Tambah Foto Baru</label>
                                ...
                                <p class="text-xs text-gray-500">Menambahkan foto baru tidak akan menghapus foto lama.</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="description" rows="4" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary">{{ old('description', $product->description) }}</textarea>
                        </div>
